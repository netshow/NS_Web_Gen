...
document.addEventListener('DOMContentLoaded', function () {
    ...
    navLinks.forEach(link => {
        ...
        const parentDropdownToggle = link.closest('.nav-item.dropdown')?.querySelector('.dropdown-toggle');
        ...
        contactForm.addEventListener('submit', function (event) {
            if (!contactForm.checkValidity()) {
                ...
                if (formMessages) {
                    ...
                    formMessages.innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert">Sending your message... <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                    setTimeout(() => {
                        formMessages.innerHTML = '<div class="alert alert-success alert-dismissible fade show" role="alert">Thank you for your message! We will get back to you soon. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                        contactForm.reset();
